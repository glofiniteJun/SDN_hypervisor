...
public abstract class Link<T1 extends Port, T2 extends Switch> implements
    ...
    public Integer getMetric() {
    	/*/ /jinheesang */
    	if(this.getClass().equals(PhysicalLink.class)){
    		if(((PhysicalLink)this).getAvailBandwidth() <= 0){
    			return 987654321;
    		}
    		else{
    			return ((PhysicalLink)this).getAssignedBandwidth() + 1;
    			//return ( (((PhysicalLink)this).getAvailPrimaryBandwidth()) * 100000 / 1 ) + 1;
    		}
    	}
    	/* jinheesang// */
    ...
    public Integer getMetricDisjoint(PhysicalFlow physicalFlow){
    	...
    	if(this.getClass().equals(PhysicalLink.class)){
    		...
    		else if(((PhysicalLink)this).isContained(physicalFlow)){
    			return 5000;
    		}
    		else{
    			return ((PhysicalLink)this).getAssignedBandwidth() + 1;
