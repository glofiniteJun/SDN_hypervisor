...
public class Path {
    ...
    private Node same;
    private Queue<Node> intermediate;
    private HashSet<Integer> intermediateHash;
    ...
    public Path(int flowID, int tenantID, int pathID) {
        ...
        this.srcSwitch = null;
        this.intermediate = new ConcurrentLinkedQueue<Node>();
        this.intermediateHash = new HashSet<Integer>();
//        this.intermediate = new LinkedList<>();
    ...
    public Queue<Node> getIntermediate() {
        return this.intermediate;
    }
    
    public HashSet<Integer> getIntermediateHash(){
